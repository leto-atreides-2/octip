...
def main():
    ...
    parser = ArgumentParser(
        description = 'Splits Brest\'s OCT dataset into train, validation and test subsets.')
    parser.add_argument('-t', '--ground_truth', required = True,
                        help = 'ground truth file generated by octip-spectralis-2-nifti.py')
    parser.add_argument('-l', '--labels', nargs = '+',
                        default = ['MLA', 'DMLA-E', 'DMLA-A', 'OMC-diabetique', 'OMC', 'IVM',
                                   'autres-pathologies'],
    ...
    urls = data['urls']
    patient_ids = [int(url.split('-')[0].split('patient')[1]) for url in urls]
