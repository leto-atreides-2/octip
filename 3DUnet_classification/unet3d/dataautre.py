...
def write_image_data_to_file1(training_files, data_storage1, data_storage2, data_storage3, truth_storage1, truth_storage2, truth_storage3):
    for index,nums in enumerate(training_files):
      path_current = nums
      os.chdir(path_current)
      cscan=np.load('cscan_array.npy')
      #print(image.shape)
      label=np.load('label_autre.npy')
      #print(label.shape)
...
def write_data_to_file1(training_data_files, out_file, image_shape1, image_shape2, image_shape3, truth_dtype=np.uint8, subject_ids=None,
    ...
    write_image_data_to_file1(training_data_files, data_storage1, data_storage2, data_storage3, truth_storage1, truth_storage2, truth_storage3)
